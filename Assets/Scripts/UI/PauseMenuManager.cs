...
namespace UI
{
   ...
   public class PauseMenuManager : MonoBehaviour
   {
      ...
      public TextMeshProUGUI resumeText = null;
      public TextMeshProUGUI quitText = null;

      // Array storing text objct with index
      // indicating the current selection
      int optionIdx = 0;
      TextMeshProUGUI[] optionArray;
      ...
      void Start()
      {
         ...
         optionArray = new TextMeshProUGUI[2];
      ...
      void Update()
      {
         ...
         TextMeshProUGUI currentSelection = optionArray[optionIdx];
         ...
         // to yellow
         currentSelection.color = Color.green;
